...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            config.weather.cloudiness = 20.0
            config.weather.precipitation = 0.0
            config.weather.precipitation_deposits = 50.0
            config.weather.wind_intensity = 0.35
            config.weather.sun_azimuth_angle = 270.0
            config.weather.sun_altitude_angle = 15.0
            config.weather.fog_density = 0.0
            config.weather.fog_distance = 0.0
            config.weather.fog_falloff = 0.0
            config.weather.wetness = 0.0
